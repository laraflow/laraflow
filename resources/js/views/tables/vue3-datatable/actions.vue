    ...
    <div class="layout-px-spacing">
                    ...
                    <div class="vue3-datatable">
                        <vue3-datatable :rows="rows" :columns="cols" :totalRows="rows?.length">
                            ...
                            <template #actions="data">
                                <div class="flex">
                                    <button type="button" class="btn btn-success me-3" @click="viewUser(data.value)">View</button>
        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="panel br-6 p-0">
                    <div class="vue3-datatable">
                        <vue3-datatable :rows="rows" :columns="cols1" :totalRows="rows?.length" rowClass="cursor-pointer" @rowClick="rowClick">
                            <template #id="data">
                                <strong>#{{ data.value.id }}</strong>
                            </template>
                        </vue3-datatable>
