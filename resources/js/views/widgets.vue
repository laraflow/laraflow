        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-unique-visitors">
                    ...
                    <div class="widget-content">
                        <apexchart v-if="unique_visitor_options" height="350" type="bar" :options="unique_visitor_options" :series="unique_visitor_series"></apexchart>
                    </div>
                </div>
            </div>
                ...
                <div class="row widget-statistic">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apexchart v-if="referral_options" height="160" type="area" :options="referral_options" :series="referral_series"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apexchart v-if="engagement_options" height="160" type="area" :options="engagement_options" :series="engagement_series"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="meta-info">
                            ...
                            <div class="avatar--group">
                                ...
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img src="/assets/images/profile-8.jpeg" alt="avatar" /></span>
                                </span>
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img src="/assets/images/profile-12.jpeg" alt="avatar" /></span>
                                </span>
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img src="/assets/images/profile-19.jpeg" alt="avatar" /></span>
                                </span>
                            </div>
                        </div>
                    </div>
